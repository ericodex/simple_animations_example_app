...
class _ExperimentState extends State<Experiment> with AnimationControllerMixin {
  ...
  @override
  void initState() {
    width = Tween(begin: 0.0, end: 1.0).animate(controller);
    controller.onStatusChange = _onStatusChange;
    super.initState();
  }
      ...
      children: <Widget>[
        ...
        Row(
          children: <Widget>[
            ...
            MaterialButton(
              onPressed: () => controller.forceCompleteCurrentTask(),
